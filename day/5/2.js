const _OP = { ADD: "01", MUL: "02", IN: "03", OUT: "04", JMP_TRUE: "05", JMP_FALSE: "06", LESS: "07", EQ: "08", FIN: "99" }
    ...
    do {
        ...
        switch (OP) {
            ...
            case _OP.JMP_TRUE:
                ...
                if (jump_true) {
                    ptr = jump_to_true
                    console.log(`${ptr}: ${[MD3, MD2, MD1, OP]} = JMP_TRUE ${jump_true} to ${jump_to_true}`)
                } else {
            ...
            case _OP.JMP_FALSE:
                ...
                if (!jump_false) {
                    ptr = jump_to_false
                    console.log(`${ptr}: ${[MD3, MD2, MD1, OP]} = JMP_TRUE ${jump_false} to ${jump_to_false}`)
                } else {
                    console.log(`${ptr}: ${[MD3, MD2, MD1, OP]} = JMP_TRUE ${jump_false}`)
                    ptr += 3
                }
